...
const dictionary = {
  en: {
    ...
    accounting: {
      ...
      paidAmountRequired: 'Paid amount is required for partial payment.',
    ...
    debitNotes: {
      ...
      debtPreview: 'Debt limit preview',
      serviceTotal: 'Service total',
      cobTotal: 'Charge-on-behalf total',
      currentDebt: 'Current debt',
      projectedDebt: 'Debt after this Debit',
      debtLimitExceeded: 'The projected debt exceeds the configured customer limit.',
      debtExceededBy: 'Debt limit exceeded by {amount}.',
      availableLimit: 'Available limit after saving: {amount}.',
      noDebtPolicy: 'This customer has no active debt policy.'
    },
    cob: {
    ...
    notifications: {
      ...
      types: {
        ...
        PAYMENT_REQUEST_PENDING_DEPARTMENT: 'Payment Request Pending Department Approval',
        PAYMENT_REQUEST_PENDING_FINAL: 'Payment Request Pending Final Approval',
        PAYMENT_REQUEST_FINAL_APPROVED: 'Payment Request Finally Approved',
    ...
    pricing: {
      ...
      categoryFcl: 'Full Container (FCL)',
      categoryLcl: 'LCL Cargo',
      categoryWaitingFee: 'Vehicle Waiting Fee',
      categoryDocumentProcedure: 'Document Procedures',
      categoryOther: 'Other',
  ...
  vi: {
    ...
    accounting: {
      ...
      paidAmount: 'Số đã thu / chi',
      paidAmountRequired: 'Vui lòng nhập số đã thu / chi khi thanh toán một phần.',
    ...
    paymentRequests: {
      ...
      actions: 'Thao tác',
      vendor: 'Nhà cung cấp',
      jobOptional: 'Mã lô hàng (Tùy chọn)',
    ...
    debitNotes: {
      ...
      noExtraNote: 'Chưa có ghi chú',
      unassignedLines: 'Dòng chưa gán job',
      total: 'Tổng cộng',
      ...
      debtPreview: 'Kiểm tra hạn mức công nợ',
      serviceTotal: 'Tổng dịch vụ',
      cobTotal: 'Tổng chi hộ',
      currentDebt: 'Công nợ hiện tại',
      projectedDebt: 'Công nợ sau Debit',
      debtLimitExceeded: 'Công nợ dự kiến vượt hạn mức của khách hàng.',
      debtExceededBy: 'Vượt hạn mức {amount}.',
      availableLimit: 'Hạn mức còn lại sau khi lưu: {amount}.',
      noDebtPolicy: 'Khách hàng chưa có chính sách công nợ đang hiệu lực.'
    },
    cob: {
      title: 'Chi hộ & Thu hộ',
    ...
    notifications: {
      ...
      types: {
        ...
        PAYMENT_REQUEST_PENDING_DEPARTMENT: 'Yêu cầu thanh toán chờ duyệt phòng ban',
        PAYMENT_REQUEST_PENDING_FINAL: 'Yêu cầu thanh toán chờ phê duyệt cuối',
        PAYMENT_REQUEST_FINAL_APPROVED: 'Yêu cầu thanh toán đã được phê duyệt',
        PAYMENT_REQUEST_REJECTED: 'Yêu cầu thanh toán bị từ chối',
        PAYMENT_REQUEST_PAID: 'Yêu cầu thanh toán đã được chi trả',
        INFO: 'Thông tin',
        WARNING: 'Cảnh báo',
        ERROR: 'Lỗi',
        SUCCESS: 'Thành công'
    ...
    pricing: {
      ...
      categoryFcl: 'Hàng nguyên container',
      categoryLcl: 'Hàng lẻ',
      categoryWaitingFee: 'Phí neo xe',
      categoryDocumentProcedure: 'Thủ tục chứng từ',
      categoryOther: 'Khác',
