...
const dictionary = {
  en: {
    ...
    users: {
      ...
      adminAssignmentDescription: 'Open Edit on any user to change their branch assignment, role set, and active status. Branch assignment controls which branch-scoped data the user can access.',
  ...
  vi: {
    ...
    users: {
      ...
      adminAssignmentDescription: 'Mở Sửa trên từng người dùng để đổi chi nhánh, bộ vai trò và trạng thái kích hoạt. Chi nhánh được gán sẽ quyết định phạm vi dữ liệu mà người dùng được xem.',
