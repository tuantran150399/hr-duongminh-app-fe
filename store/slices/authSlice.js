...
export const PERMISSIONS = {
  ...
  PAYMENT_REQUEST_VIEW: 'payment-request:view',
  PAYMENT_REQUEST_CREATE: 'payment-request:create',
  PAYMENT_REQUEST_DEPARTMENT_APPROVE: 'payment-request:department-approve',
  PAYMENT_REQUEST_FINAL_APPROVE: 'payment-request:final-approve',
  PAYMENT_REQUEST_MARK_PAID: 'payment-request:mark-paid',
...
export const ROLE_PERMISSIONS = {
  ...
  [ROLES.ADMIN]: [
    ...
    PERMISSIONS.PAYMENT_REQUEST_DEPARTMENT_APPROVE,
    PERMISSIONS.PAYMENT_REQUEST_FINAL_APPROVE,
    PERMISSIONS.PAYMENT_REQUEST_MARK_PAID,
